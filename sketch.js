...
gameOver = loadSound("gameOver.mp3");
  ...
  clickImage = loadImage("click here.png");
...
function setup() {
 ...
 sun.addImage(sunImage);
  sun.scale = 0.2;
   ...
   game_Over = createSprite(windowWidth-1150, windowHeight-200, 20, 20);
   game_Over.addImage(gameOverImage);
  
  
  restart = createSprite(windowWidth-750, windowHeight-200, 20, 20);
   restart.addImage(restartImage);


     click = createSprite(windowWidth-750, windowHeight-150, 20, 20);
